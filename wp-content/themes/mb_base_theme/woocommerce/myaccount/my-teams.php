		...
		<table class="shop_table shop_table_responsive my_account_orders my_account_teams">
			...
			<tbody>
				<?php foreach ( $teams as $team ) : // TODO: PAGING ?>
					...
					<tr class="team">
						<?php foreach ( $my_teams_columns as $column_id => $column_name ) : 
							//$t_url= esc_url( wc_get_account_endpoint_url( "teams" ).$team->get_id()."/settings" );
...
?>
							...
							<?php if ( 'team-name' === $column_id ) : ?>
								...
								<span style="color:#b75231"><?php echo esc_html( $team->get_name() ); ?></span>
							...
							<?php elseif ( 'team-actions' === $column_id ) :
								...
								<a class="button wc-memberships-for-teams-team-area-action view" href="<?php echo esc_url( wc_get_account_endpoint_url( "teams" ).$team->get_id()."/members") ; ?>">
								Manage</a>
