 ...
 * @type \SkyVerge\WooCommerce\Memberships\Teams\Emails\Membership_Ended $email email object
...
printf(
	/* translators: Placeholder: %s - site title */
	esc_html__( 'Oh no, your team membership access at %s has now ended!', 'woocommerce-memberships-for-teams' ),
	$site_title
);
